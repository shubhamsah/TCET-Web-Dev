...
console.log(names.toString()) // Shubham,Mathias,Elias,Brook
```
...
console.log(names.join()) // Shubham,Mathias,Elias,Brook
console.log(names.join('')) //ShubhamMathiasEliasBrook
console.log(names.join(' ')) //Shubham Mathias Elias Brook
console.log(names.join(', ')) //Shubham, Mathias, Elias, Brook
console.log(names.join(' # ')) //Shubham # Mathias # Elias # Brook
