...
```js
console.log('%s JavaScript', 'Learning')
```
...
```js
console.log('%cLearning JavaScript', 'color:green') // log output is green
console.log(
  '%cLearning%c %cJavaScript%c',
  'color:green',
  '',
  'color:red',
  '',
...
```js
console.info('Learning JavaScript challenge is trending on Github')
console.info('Learning fullStack challenge might be released')
console.info('Learning HTML and CSS challenge might be released')
```
