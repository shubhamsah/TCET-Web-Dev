...
const person1 = new Person('Shubham', 'Sah')

console.log(person1)
```

```sh
Person {firstName: "Shubham", lastName: "Sah"}
```
...
const person3 = new Person('Abraham', 'Sah')
...
Person {firstName: "Abraham", lastName: "Sah"}
```
...
const person1 = new Person('Shubham', 'Sah', 250, 'India', 'Mumbai')

console.log(person1)
```

```sh
Person {firstName: "Shubham", lastName: "Sah", age: 250, country: "India", city: "Mumbai"}
```
...
["Planning", "Managing", "Organizing"]
[]
Shubham Sah is 250. He lives Mumbai, India. He knows HTML, CSS and JavaScript
...
const s1 = new Student('Shubham', 'Sah', 'India', 250, 'Mumbai')
console.log(s1)
...
```sh
Student {firstName: "Shubham", lastName: "Sah", age: "India", country: 250, city: "Mumbai", …}
I am a child of the person class
Shubham Sah
Student {firstName: "Shubham", lastName: "Sah", age: "India", country: 250, city: "Mumbai", …}
Shubham Sah is India. He lives Mumbai, 250.
```
...
const s2 = new Student('Lidiya', 'Tekle', 28, 'India', 'Mumbai', 'Female')
s1.setScore = 1
s1.setSkill = 'HTML'
s1.setSkill = 'CSS'
...
```sh
Student {firstName: "Shubham", lastName: "Sah", age: 250, country: "India", city: "Mumbai", …}
Student {firstName: "Lidiya", lastName: "Tekle", age: 28, country: "India", city: "Mumbai", …}
I am a child of the person class
Shubham Sah
Student {firstName: "Shubham", lastName: "Sah", age: 250, country: "India", city: "Mumbai", …}
Shubham Sah is 250. He lives in Mumbai, India. He knows HTML, CSS and JavaScript
I am a child of the person class
Lidiya Tekle
Student {firstName: "Lidiya", lastName: "Tekle", age: 28, country: "India", city: "Mumbai", …}
Lidiya Tekle is 28. She lives in Mumbai, India. He knows Planning, Managing and Organizing
```